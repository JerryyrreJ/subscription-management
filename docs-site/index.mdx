...
- Start with [Getting started](/getting-started) for local development.
- Use [Configuration](/configuration) to decide which environment variables you need.
- Use [Deployment](/deployment) before publishing the app.
- Use [Public API overview](/api/overview) when integrating with scripts, agents, or third-party tools.
