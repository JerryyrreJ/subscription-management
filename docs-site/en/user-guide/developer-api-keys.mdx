...
All signed-in users can create API keys. The server keeps shared abuse rate limits; Premium may raise internal ceilings, but those numbers are not a marketing differentiator on the pricing page. The Developer API screen shows your current plan, active key count, and hourly request limit.
