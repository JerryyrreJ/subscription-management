...
description: "Configure Supabase for authentication, cloud sync, user profiles, notification settings, payments, API keys, and AI capture quotas."
---
...
- AI usage windows track per-user monthly AI capture counts.
