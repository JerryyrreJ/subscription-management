...
description: "Use Developer API keys to automate subscription CRUD through the v1 public API."
---

# Public API overview

The v1 public API exposes subscription CRUD through Developer API keys. It is designed for scripts, agents, automation tools, and third-party integrations.
...
Subscription endpoints live under:
