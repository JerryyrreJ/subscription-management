---
title: "Configuration"
description: "Environment variables and feature flags for local-first, hosted, payment, notification, and public API deployments."
---
...
| `SUPABASE_SECRET_KEY` | Notifications, premium activation, and public API access | Server only |
...
Use browser variables only for public configuration such as Supabase URL, Supabase anon key, and Stripe publishable key.
