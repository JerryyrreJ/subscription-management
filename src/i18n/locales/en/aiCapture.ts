export const aiCapture = {
  ...
  completeTitle: 'Done',
  completeDetail: 'The AI action is complete.',
  createCompleteDetail: 'Added {{count}} subscription(s).',
  deleteCompleteDetail: 'Deleted {{name}}.',
  updateCompleteDetail: 'Updated {{name}}.',
  batchUpdateCompleteDetail: 'Updated {{count}} subscriptions.',
  undoing: 'Undoing…',
  enabled: 'On',
  disabled: 'Off',
  ...
  batchUpdateTitle: 'Update {{count}} subscriptions?',
  batchUpdateDone: 'Updated {{count}} subscriptions.',
  ...
  confirmBatchUpdate: 'Apply {{count}} updates',
  ...
  fields: {
    ...
    nextPaymentDate: 'Next renewal',
    customDate: 'Custom interval',
    notificationEnabled: 'Notifications',
  },
  undo: {
    created: 'Added {{name}}',
    batchCreated: 'Added {{count}} subscriptions',
    deleted: 'Deleted {{name}}',
    updated: 'Updated {{name}}',
    batchUpdated: 'Updated {{count}} subscriptions',
    action: 'Undo',
  ...
  warnings: {
    ...
    category_defaulted: 'Mapped to an existing category — please confirm',
    ...
    nextPaymentDate_guessed: 'Renewal date was missing — set the next renewal date',
