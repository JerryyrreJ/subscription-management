...
export function SyncIndicator({ status, isOnline, onSync }: SyncIndicatorProps) {
 ...
 bgColor: 'bg-gray-100 dark:bg-[#1a1c1e]'
 }
 }
 ...
 icon: RefreshCw,
 text: 'Syncing...',
 color: 'text-emerald-700 dark:text-emerald-400 dark:text-zinc-600 dark:text-zinc-400',
 bgColor: 'bg-[#f4f5f7] dark:bg-[#202225] dark:bg-zinc-800/20',
 ...
 bgColor: 'bg-gray-50 dark:bg-[#1a1c1e]'
 }
 }
 }
 ...
 className="relative p-2 rounded-2xl bg-white dark:bg-[#1a1c1e] shadow-apple hover:shadow-fey transition-all duration-700 hover:duration-500 ease-in-out group overflow-hidden w-10 hover:w-auto"
 >
