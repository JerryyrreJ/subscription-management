...
export function Tooltip({ children, content, position = 'bottom', delay = 300 }: TooltipProps) {
 ...
 <div className="bg-gray-800 dark:bg-gray-200 text-white dark:text-gray-800 text-xs rounded-lg py-1 px-2 whitespace-nowrap">
 {content}
 </div>
